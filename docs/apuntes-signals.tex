...
%  Compilar con: xelatex apuntes-signals.tex
% ============================================================
...
\begin{titlepage}
  ...
  \begin{tcolorbox}[importante, title=Cómo compilar este archivo]
    Requiere \textbf{XeLaTeX} (no pdflatex).\\
    Comando: \texttt{xelatex apuntes-signals.tex}\\
    O en Overleaf: compilador \textbf{XeLaTeX}.
  \end{tcolorbox}
\end{titlepage}
